  ...
  useEffect(() => {
    ...
    stations.forEach(station => {
      ...
      if (station.wikipedia_ru) {
        popupHTML += `<div><strong>Wikipedia:</strong> <a href="https://ru.wikipedia.org/wiki/${encodeURIComponent(station.wikipedia_ru)}" target="_blank" rel="noopener noreferrer" style="color: #2563eb; text-decoration: underline;">${station.wikipedia_ru}</a></div>`;
      }
